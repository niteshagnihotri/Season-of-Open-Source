...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>
        Season of Open Source Program 2023
        </title>
        ...
        <div className="first-section mb-10 flex flex-col md:flex-row">
          <div className="basis-1/2 relative">
            <div className="text-black dark:text-white text-6xl font-sans font-semibold 2.25rem 3rem mb-10">
              <span className="text-primary_orange-0">SoOS </span>
              2023
              <div className="mt-2">is here!</div>
            </div>
            <div className="font-serif font-medium text-2xl  text-gray-800 dark:text-white mb-24">
            Season of Open Source is a 2-month long 
              <span className="text-primary_orange-0"> #OpenSource </span> Program by <br/>
              CodeIN Community & Community Coders.
              <br />
        ...
        <div className="flex justify-between items-center flex-wrap mb-24">
          ...
          <div className="basis-full md:basis-6/12 md:order-last lg:basis-1/2 lg:order-last relative">
            ...
            <div className="text-black dark:text-white font-semibold text-4xl 2.25rem 3rem mb-5 font-sans">
              About <span className="text-primary_orange-0"> Season of Open Source </span>
              Program
            </div>
            <p className="dark:text-white font-serif text-1xl text-black-100">
            Season of Open Source Program is a 2-month long OpenSource program by CodeIN Community & Community Coders. Participants contribute to open-source repositories under the guidance of project admins & mentors over these months. With Season of open source, students will get exposure to real-world projects and will help them to get started with open source.
            </p>
      ...
      <div className="schedule__container flex flex-col items-center mb-48 ">
        <div className="schedule__overview mt-24 relative">
          <p className="font-sans font-semibold text-3xl ml-5 mb-4 dark:text-white">
            <span className="text-primary_orange-0">Schedule</span> of SoOS
            2023!
          </p>
          {theme === "light" ? (
            <img
